...
import { ArrowLeft, Building2, AlertCircle, Shield } from "lucide-react";
          ...
          <div className="card-easytrust p-10 flex flex-col items-center text-center space-y-5">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-navy-500 max-w-xs">
                Bank-to-bank transfers can only be initiated by customers. As a <span className="font-semibold text-navy-700">{user.role}</span>, you do not have permission to transfer funds.
              </p>
            </div>
            <motion.button
