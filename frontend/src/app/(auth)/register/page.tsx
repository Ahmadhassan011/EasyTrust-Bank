...
import { Landmark, AlertCircle, Eye, EyeOff, X } from "lucide-react";
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}       transition={{ duration: 0.5, ease: easeOut }}
      ...
      <div className="card-easytrust p-8 relative">
        ...
        <div className="text-center">
          ...
          <h1 className="mt-5 text-2xl font-bold text-foreground" style={{ fontFamily: "var(--font-display)", fontWeight: 500 }}>Create account</h1>
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-5">
          ...
          <div>
            <label className="mb-1.5 block text-sm font-medium text-foreground">CNIC</label>
