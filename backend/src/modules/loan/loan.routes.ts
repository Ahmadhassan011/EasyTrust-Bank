...
const { applyLoanSchema, approveLoanSchema, repayLoanSchema } = require("./loan.validation");
...
router.patch("/:id/reject", authorize("LOAN_OFFICER", "MANAGER", "ADMIN"), validate(approveLoanSchema), loanController.reject);
